...
func (c *deepseekClient) MatchResume(ctx context.Context, fileB64 string, fileMime string, vacancies []string) (*domain.MatchResult, error) {
	...
	builder.WriteString("O campo 'role' é o cargo copiado do anúncio, sem inventar nem reescrever, porque vai literalmente na mensagem enviada ao recrutador. Se o anúncio não disser o cargo, retorne string vazia.\n")
